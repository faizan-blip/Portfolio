...
import ft from '../Components/Images/logo.png'
import inn from '../Components/Images/in.png'
...
import {SiExpress,SiMui,SiFirebase,SiFramer, SiJavascript} from 'react-icons/si'
...
}
{
  ...
  <Paper onClick={() => {
    ...
    window.open(url, '_blank');
        ...
        <img src={ft} alt="" width={100} style={{position:"absolute" , top:"45%" , left:"50%" , transform:"translate(-50% , -50%)"}} />
        <Typography sx={{position:"absolute"  , left:"10%" , top:"10%" , fontSize:"20px" , color:"#fff"}}>First-talk</Typography>
        ...
        <Fab className='hover3'  variant='contained' sx={{position:"absolute" , bottom:"10%" , right:"20%" , background:"none !important" , color:"#fff" , backdropFilter:"blur(2px)" , fontWeight:"700" , borderRadius:"25px" }}><SiFirebase/></Fab>
        <Fab  className='hover3' variant='contained' sx={{position:"absolute" , bottom:"10%" , right:"30%" , background:"none !important" , color:"#fff" , backdropFilter:"blur(2px)" , fontWeight:"700" , borderRadius:"25px" }}><SiMui/></Fab>
    ...
    window.open(url, '_blank');
        ...
        <img src={inn} alt="" width={100} style={{position:"absolute" , top:"45%" , left:"50%" , transform:"translate(-50% , -50%)"}} />
        <Typography sx={{position:"absolute"  , left:"10%" , top:"10%" , fontSize:"20px" , color:"#fff"}}>Hands-Down</Typography>
        <Fab className='hover3'  variant='contained' sx={{position:"absolute" , bottom:"10%" , right:"10%" ,  background:"none !important" , color:"#fff" , backdropFilter:"blur(2px)" , fontWeight:"700" , borderRadius:"25px" }}><FaReact/></Fab>
    ...
    window.open(url, '_blank');
        ...
        <img src={meta} alt="" width={100} style={{position:"absolute" , top:"50%" , left:"50%" , transform:"translate(-50% , -50%)"}} />
       ...
       <Skeleton variant='rounded' sx={{width:"200px" , height:"10em",position:"absolute" , top:"40%" , left:"50%" , transform:"translate(-50% , -50%)" , bgcolor:'#494949' }}/>
       <Skeleton variant="circular"  sx={{position:"absolute" , bottom:"5%" , right:"10%"  , bgcolor:'#494949'  }}><Fab/></Skeleton>
       <Skeleton variant="circular"  sx={{position:"absolute" , bottom:"5%" , right:"20%"  , bgcolor:'#494949'  }}><Fab/></Skeleton>
       <Skeleton variant="circular"  sx={{position:"absolute" , bottom:"5%" , right:"30%"  , bgcolor:'#494949'  }}><Fab/></Skeleton>
       </Paper> 
  </Box>
  </motion.div>
}
