...
window.addEventListener('scroll', handleScroll);
  return (
    <div id='project'>
  <Box sx={{height:"100%" , minHeight:{lg:"100vh" , xs:"100%"}, background:"transparent" , color:"#fff" , display:"flex", width:"100%" , marginTop:{xl:"5.2em",lg:"3.5em" , xs:"0em"} , flexDirection:"column" , gap:"1.5em" , padding:{lg:"0" ,xs:"3em 0em"}}}>
  {
    show &&
  <motion.div 
